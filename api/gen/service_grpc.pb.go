...
const (
	MyService_GetData_FullMethodName = "/gendbapi.MyService/GetData"
)
...
func (c *myServiceClient) GetData(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, MyService_GetData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMyServiceServer) GetData(context.Context, *Request) (*Response, error) {
...
func _MyService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyServiceServer).GetData(ctx, req.(*Request))
	}
...
var MyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gendbapi.MyService",
